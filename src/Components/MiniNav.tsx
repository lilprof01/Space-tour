    ...
    <nav className="mini-nav self-center lg:self-start">
      <ul className="flex justify-between items-center align-middle gap-8 text-white text-[16px]">
        <li
          ...
          id="moon"
          className={`nav-links py-3 ${activePage === "moon" ? "active" : ""}`}
        >
          MOON
        </li>
        <li
          ...
          id="mars"
          className={`nav-links py-3 ${activePage === "mars" ? "active" : ""}`}
        >
          MARS
        </li>
        <li
          ...
          id="europa"
          className={`nav-links py-3 ${
            activePage === "europa" ? "active" : ""
          }`}
        >
          EUROPA
        </li>
        <li
          ...
          id="titan"
          className={`nav-links py-3 ${activePage === "titan" ? "active" : ""}`}
        >
          TITAN
        </li>
      </ul>
